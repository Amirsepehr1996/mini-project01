...
# best hyperparameters for MLP:   (16, 8), lr_init=0.005, threshold=0.3
# best hyperparameters for LR:    threshold=0.2, c = 0.1
# best hyperparameters for KNN:   k = 3
# best hyperparameters for DT:    max_depth=5, min_samples_leaf=10, min_samples_split=20
